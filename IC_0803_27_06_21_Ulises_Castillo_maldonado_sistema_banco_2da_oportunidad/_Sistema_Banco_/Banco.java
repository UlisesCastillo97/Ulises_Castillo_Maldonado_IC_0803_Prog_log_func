class Banco {
    ...
    public void setEspecificoCliente(int index, Cliente cliente){
       ...
       // this.clientes[index].setTodosDatos();
    }
    ...
    public void cambiarAppCliente(int index, String nuevoApp){
        this.clientes[index].cambiarApp(nuevoApp);
    }
    public void cambiarApmCliente(int index, String nuevoApm){
        this.clientes[index].cambiarApm(nuevoApm);
    }
    public void cambiarEdadCliente(int index, int nuevaEdad){
        this.clientes[index].cambiarEdad(nuevaEdad);
    }
