public class SystemBanc {
    static final int MOSTRAR_MENU_PRIN = 0;
    static final int LIMITE_PAISES = 5;
    static final int LIMITE_CLIENTES = 10;
    static final int ALTA = 1;
    static final int BAJA = 2;
    static final int MOSTRAR_TODO = 3;
    static final int MOSTRAR_ESPECIFICO = 4;
    static final int MOSTRAR_OCUPADOS = 5;
    static final int ABONAR = 6;
    static final int RETIRAR = 7;
    static final int BUSCAR_ID_VACIO_ESTRUCTURA = 8;
    static final int ESTA_LLENA_ESTRUCTURA = 9;
    static final int ESTA_VACIA_ESTRUCTURA = 10;
    static final int IMPRIMIR_NOM_PAISES = 11;
    static final int MOSTRAR_LONGITUDES = 12;
    static final int ACTUALIZAR = 13;
    static final int SALIR = 14;
    static final int ACTUALIZAR_MOSTRAR_MENU = 0;
    static final int ACTUALIZAR_NOMBRE = 1;
    static final int ACTUALIZAR_APP = 2;
    static final int ACTUALIZAR_APM = 3;
    static final int ACTUALIZAR_EDAD = 4;
    static final int ACTUALIZAR_SEXO = 5;
    static final int SALIR_ACTUALIZAR = 6;
    ...
    private static void introducirPaises(Banco banco[]){
        for(int i = 0; i < banco.length; i++){
            ...
            banco[i] = new Banco(pais, SystemBanc.validarRango(1, LIMITE_CLIENTES, mensaje));
        }
    }
    ...
    private static void instrucciones_actualizar(){
        ...
        System.out.print(" 2 Acrtualizar App");
        System.out.print(" 3 Acrtualizar Apm");
        System.out.print(" 4 Actualizar Edad.\n");
        System.out.print(" 5 Actualizar Sexo.\n");
        System.out.print(" 6 Regresar a ménu principal.\n");
        System.out.println("-------------------------------");
    }
    ...
    public static void main(String[] args) {
        int eleccion;
        Banco banco[];
        banco = new Banco[SystemBanc.validarRango(1, LIMITE_PAISES, "Introduce el número de paises: ")];
                    ...
                    if(SystemBanc.hayVacioTodaEstructura(banco)){
                        ...
                        if(cliente != -1){
                            ...
                            Cliente temp = new Cliente();
                                    ...
                                    temp.setTodosDatos(entrada.cadena("Introduce nombre del cliente: "), 
                                            entrada.cadena("Introduce App del cliente: "),
                                            entrada.cadena("Introduce Appm del cliente: "),
                                            entrada.entero("Introduce Edad del cliente: "),
                                            entrada.cadena("Introduce Sexo del cliente: ").charAt(0), 
                                            entrada.doble("Introduce el Sueldo: "));
                                   
                                    /*
                                    SystemBanc.entrada.cadena("Introduce nombre del cliente: "),
                                    SystemBanc.entrada.cadena("Introduce el App del cliente: "),
                                    SystemBanc.entrada.cadena("Introduce el Apm del cliente: "),
                                    SystemBanc.entrada.entero("Introduce la Edad del cliente: "),
                            ...
                            while(eleccion != SALIR_ACTUALIZAR) {
                                switch (eleccion) {
                                    case ACTUALIZAR_NOMBRE:
                                        ...
                                        break;
                                    case ACTUALIZAR_APP:
                                        System.out.println("--- Opción actualizar app ---");
                                        banco[pais].cambiarAppCliente(cliente,
                                                SystemBanc.entrada.cadena("Introduce nuevo app del cliente: "));
                                        System.out.println("-----------------------------------------------------------------");
                                        banco[pais].printCliente(cliente);
                                        System.out.println("-----------------------------------------------------------------");
                                        break;
                                    case ACTUALIZAR_APM:
                                        System.out.println("--- Opción actualizar apm ---");
                                        banco[pais].cambiarApmCliente(cliente,
                                                SystemBanc.entrada.cadena("Introduce nuevo apm del cliente: "));
                                        System.out.println("-----------------------------------------------------------------");
                                        banco[pais].printCliente(cliente);
                                        System.out.println("-----------------------------------------------------------------");
                                        break;
                                    case ACTUALIZAR_EDAD:
                                        System.out.println("--- Opción actualizar app ---");
                                        banco[pais].cambiarEdadCliente(cliente,
                                                SystemBanc.entrada.entero("Introduce nuevo app del cliente: "));
                                        System.out.println("-----------------------------------------------------------------");
                                        banco[pais].printCliente(cliente);
                                        System.out.println("-----------------------------------------------------------------");
                                        break;   
